...
ALTER TABLE `jobs`  ADD CONSTRAINT `jobs_ibfk_1` FOREIGN KEY (`created_by`) REFERENCES `users` (`guid`),  ADD CONSTRAINT `jobs_ibfk_2` FOREIGN KEY (`agent_id`) REFERENCES `agents` (`id`);
